...
def get_tickets_title(numbers):
    ...
    #              "author": {"id": 7, "name": "Pippo Pero"}, "assigned_to": {"id": 16, "name": "Rocco Mancin"},
    ...
    #              "status": {"id": 1, "name": "Nuovo"}, "priority": {"id": 2, "name": "Normale"},
    #              "author": {"id": 7, "name": "Pippo"},
    #              "assigned_to": {"id": 7, "name": "Pippo"},
    #              "category": {"id": 206, "name": "Documentazione"}, "fixed_version": {"id": 5, "name": "SIEM Cloud"},
    #              "parent": {"id": 7211},
...
def seconds_to_time_entry_format(seconds, rounding):
    ...
    if seconds % rounding != 0:
        ...
        upper = (seconds // rounding + 1) * rounding
        lower = (seconds // rounding) * rounding

        if lower == 0:
            seconds = upper
        elif abs(seconds - lower) < abs(seconds - upper):
            seconds = lower
        else:
            seconds = upper
